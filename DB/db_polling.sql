...
--
-- Host: localhost:3306
-- Generation Time: Aug 11, 2026 at 06:16 AM
...
CREATE TABLE `nilai_alternatif` (
  `id_nilai_alternatif` int NOT NULL,
  `id_alternatif` int NOT NULL,
  `id_kriteria` int NOT NULL,
  `nilai` int NOT NULL,
  `periode` varchar(30) NOT NULL
...
CREATE TABLE `temp` (
  ...
  `Pengajaran` int DEFAULT NULL,
  `Penelitian_n_Publikasi` int DEFAULT NULL,
  `Pengabdian_Masyarakat` int DEFAULT NULL,
  `Penunjang` int DEFAULT NULL,
...
--
ALTER TABLE `desc_kriteria`
  MODIFY `id_desc` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `nilai_alternatif`
  MODIFY `id_nilai_alternatif` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `pemberian_skor`
  MODIFY `id_pemberian` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `periode`
--
ALTER TABLE `periode`
  MODIFY `id_periode` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
